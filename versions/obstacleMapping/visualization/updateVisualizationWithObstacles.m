function handles = updateVisualizationWithObstacles(handles, xTrue, xKF, xEKF, xUKF, P_KF, P_EKF, P_UKF, trajTrue, trajKF, trajEKF, trajUKF, iteration, params)
...
xlabel('x [m]');
ylabel('y [m]');
title('Robot Trajectories and Uncertainty');
...
legend('Obstacle', 'True', 'KF', 'EKF', 'UKF', 'Location', 'best');
