...
xlabel('x [m]');
ylabel('y [m]');
title('KF: Certainty of Path', 'FontWeight', 'bold', 'Color', params.colorKF);
grid on;
...
xlabel('x [m]');
ylabel('y [m]');
title('EKF: Certainty of Path', 'FontWeight', 'bold', 'Color', params.colorEKF);
grid on;
...
xlabel('x [m]');
ylabel('y [m]');
title('UKF: Certainty of Path', 'FontWeight', 'bold', 'Color', params.colorUKF);
grid on;
