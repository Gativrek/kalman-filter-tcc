...
%% Add paths
addpath('shared/filters', 'shared/models', 'shared/simulation', 'shared/visualization', 'shared/mapping', 'shared/utils', 'versions/heatMapping', 'versions/heatMapping/visualization');
...
handles = updateVisualizationHeatMap(handles, xTrue, xKF, xEKF, xUKF, P_KF, P_EKF, P_UKF, trajTrue, trajKF, trajEKF, trajUKF, 1, params, heatMap_KF, heatMap_EKF, heatMap_UKF);
...
for k = 1:params.maxIterations
    ...
    handles = updateVisualizationHeatMap(handles, xTrue, xKF, xEKF, xUKF, P_KF, P_EKF, P_UKF, trajTrue, trajKF, trajEKF, trajUKF, k, params, heatMap_KF, heatMap_EKF, heatMap_UKF);

    fullTimeKF = fullTimeKF + timeKF;
    fullTimeEKF = fullTimeEKF + timeEKF;
    fullTimeUKF = fullTimeUKF + timeUKF;
