%% Unicycle Robot - Automatic Test (Clean Version - No Obstacles)
% This is the WORKING baseline version before obstacle mapping
...
fig = figure('Name', 'Unicycle Filter Comparison', ...
...
handles = updateVisualization(handles, xTrue, xKF, xEKF, xUKF, ...
                              P_KF, P_EKF, P_UKF, ...
                              trajTrue, trajKF, trajEKF, trajUKF, ...
                              1, params);

fprintf('Visualization ready!\n');
fprintf('Running automatic trajectory...\n\n');
