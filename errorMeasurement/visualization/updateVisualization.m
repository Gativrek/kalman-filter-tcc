function handles = updateVisualization(handles, xTrue, xKF, xEKF, xUKF, P_KF, P_EKF, P_UKF, ...
...
title('Robot Trajectories (Top View)', 'Interpreter', 'latex', 'FontSize', 12, 'FontWeight', 'bold');
...
text(0.02, 0.98, sprintf('Iteration: %d/%d', iteration, params.maxIterations), ...
...
ylabel('$x$ Error [m]', 'Interpreter', 'latex', 'FontSize', 10);
title('X Position Error', 'Interpreter', 'latex', 'FontSize', 11, 'FontWeight', 'bold');
...
xlabel('Iteration', 'Interpreter', 'latex', 'FontSize', 10);
ylabel('$y$ Error [m]', 'Interpreter', 'latex', 'FontSize', 10);
title('Y Position Error', 'Interpreter', 'latex', 'FontSize', 11, 'FontWeight', 'bold');
xlim([1, params.maxIterations]);
...
xlabel('Iteration', 'Interpreter', 'latex', 'FontSize', 10);
ylabel('$\theta$ Error [deg]', 'Interpreter', 'latex', 'FontSize', 10);
title('Heading Error', 'Interpreter', 'latex', 'FontSize', 11, 'FontWeight', 'bold');
